...
SCRIPT=$0
JOB_SCRIPT="./experiments/download_gnomad_v3_genomes/download_gnomad_genomes.sh"
DIR_GNOMAD_V3="/mnt/bmh01-rds/Ellingford_gene/public_data_resources/gnomad/v3.1.2/genomes"
DIR_LOGS="data/logs/cluster/download_gnomad_v3"

# Clean slate in the download directory and cluster logs
for dir in $DIR_GNOMAD_V3 $DIR_LOGS; do
    [[ -d $dir ]] && rm -rf $dir
    mkdir -p $dir
done
